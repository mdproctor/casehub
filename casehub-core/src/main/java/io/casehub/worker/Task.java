 ...
 *
 * <p>Tasks can be created in two ways (see {@link TaskOrigin}):
 * <ul>
 *   <li><b>BROKER_ALLOCATED</b>: Traditional request-response via TaskBroker</li>
 *   <li><b>AUTONOMOUS</b>: Self-initiated by decentralized workers that work on their own agency</li>
 * </ul>
 *
 * @see TaskRequest
 * @see TaskStatus
...
public class Task {
    ...
    public Task() {
        ...
        this.taskOrigin = TaskOrigin.BROKER_ALLOCATED;  // Default
        this.caseFileId = Optional.empty();
    }
    ...
    public TaskOrigin getTaskOrigin() { return taskOrigin; }
    public void setTaskOrigin(TaskOrigin origin) { this.taskOrigin = origin; }
    public Optional<String> getCaseFileId() { return caseFileId; }
    public void setCaseFileId(String caseFileId) { this.caseFileId = Optional.ofNullable(caseFileId); }
}
